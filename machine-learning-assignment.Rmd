...
The accuracy for the random forest model seems to be pretty high, so we are going to use this model to train the whole training set. Our predicted accuracy for the out of sample error is `r 100-matr[[3]][1]*100 ` .
